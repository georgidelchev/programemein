...
namespace Programemein.Data.Migrations
{
    ...
    [Migration("20211109112006_RemoveImageUrlFromMemeAndAddOneToOneWithImageDataTable")]
    partial class RemoveImageUrlFromMemeAndAddOneToOneWithImageDataTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Programemein.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MemeTag", b =>
                {
                    b.HasOne("Programemein.Data.Entities.Meme", null)
                        .WithMany()
                        .HasForeignKey("MemesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Programemein.Data.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Programemein.Data.Entities.User", null)
                        .WithMany()
